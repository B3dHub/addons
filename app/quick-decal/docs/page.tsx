  ...
  return (
    <div className="flex flex-col justify-center mx-auto gap-5 max-w-[832px]">
      <Card>
        ...
        <CardContent>
          <CardDescription>
            You need to add the custom decal library path in the preferences, under the Libraries section.
          </CardDescription>
        </CardContent>
        <CardContent>
          <Image
        ...
        <CardContent>
          <CardDescription>
            Once you've added the path, the addon will display the decals in the Decals panel under the{" "}
        ...
        <CardContent>
          <CardDescription>
            If you don't have any images in the specified path, you can load the decals.
          </CardDescription>
        </CardContent>
        <CardContent>
          <Image
        ...
        <CardContent>
          <CardDescription>
            Once the decals are loaded, they will be saved in the custom decal library path for future use.
          </CardDescription>
        </CardContent>
        <CardContent>
          <Image
      ...
      <Card>
        ...
        <CardContent>
          <CardDescription>
            You can use the hotkeys <span>Shift</span> and <span>Ctrl</span> for quick access.
          </CardDescription>
        </CardContent>
        <CardContent>
